...
root.geometry("1080x400")  # Corrected geometry specification
root.resizable(False, False)  # Fixed capitalization
...
try:
    ...
    print("Error: 'Google_Translate_logo.png' not found.")

# Arrow
try:
    arrow_image = PhotoImage(file="arrow.png")
    image_label = Label(root, image=arrow_image)  # Fixed `label` to `Label`
